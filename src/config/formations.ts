...
export const FORMATIONS: Record<FormationId, FormationDef> = {
  inferno: {
    id: 'inferno', name: '燎原阵', condition: 'two-fire',
    effectDescription: '火印记持续 +50%',
  },
  glacier: {
    id: 'glacier', name: '寒冰领域', condition: 'two-ice',
    effectDescription: '冰印记率 +25%，印记自带 10% 减速',
  },
  grid: {
    id: 'grid', name: '电网', condition: 'two-thunder',
    effectDescription: '电弧塔 +1 跳',
  },
  reactor: {
    id: 'reactor', name: '剧毒反应堆', condition: 'poison-thunder',
